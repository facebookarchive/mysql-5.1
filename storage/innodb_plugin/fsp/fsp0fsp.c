...
double fseg_reserve_factor = 0.01;
...
#  error
# endif
# if UNIV_PAGE_SIZE_DEF <= XDES_ARR_OFFSET				\
			   + (UNIV_PAGE_SIZE_DEF / FSP_EXTENT_SIZE_DEF)	\
			   * XDES_SIZE_DEF
#  error
# endif
...
#endif
#if UNIV_PAGE_SIZE_DEF % FSP_EXTENT_SIZE_DEF
# error "UNIV_PAGE_SIZE_DEF % FSP_EXTENT_SIZE_DEF != 0"
#endif
