...
static SHOW_VAR innodb_status_variables[]= {
  ...
  (char*) &export_vars.innodb_data_fsync_max_secs,        SHOW_DOUBLE},
  {"data_fsync_slow",
  ...
  (char*) &export_vars.innodb_data_log_write_svc_secs,   SHOW_DOUBLE},
  ...
  (char*) &export_vars.innodb_data_double_write_svc_secs,   SHOW_DOUBLE},
...
/*=====================*/
{
	...
	dict_update_statistics(prebuilt->table, TRUE, TRUE, trx);
					...
					::analyze() */
{
	...
	if (flag & HA_STATUS_VARIABLE) {
		...
		// This is the upstream fix for http://bugs.mysql.com/53046
		// Disabling it because mcallaghan says ours is better.
