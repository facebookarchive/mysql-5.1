...
static bool int_close_cached_tables(THD *thd, TABLE_LIST *tables, bool have_lock,
                         bool wait_for_refresh, bool wait_for_placeholders,
                         bool clear_memory_cache, bool set_readonly_mode)
{
  bool result=0;
                         ...
                         bool clear_memory_cache)
{
  return int_close_cached_tables(thd, tables, have_lock, wait_for_refresh,
                                  wait_for_placeholders, clear_memory_cache,
                                  FALSE);
}

bool close_cached_tables_set_readonly(THD *thd)
{
  return int_close_cached_tables(thd, NULL, FALSE, TRUE, TRUE, FALSE, TRUE);
}
