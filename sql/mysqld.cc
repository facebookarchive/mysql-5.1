...
SHOW_VAR com_status_vars[]= {
  ...
  {"ha_open_read_close",   (char*) offsetof(STATUS_VAR, com_stat[(uint) SQLCOM_HA_OPEN_READ_CLOSE]), SHOW_LONG_STATUS},
  ...
  {"show_engine_transaction",(char*) offsetof(STATUS_VAR, com_stat[(uint) SQLCOM_SHOW_ENGINE_TRX]), SHOW_LONG_STATUS},
...
static int init_thread_environment()
{
  ...
  (void) pthread_mutex_init(&LOCK_sql_rand, MY_MUTEX_INIT_FAST);
#ifdef HAVE_OPENSSL
...
#include "sslopt-longopts.h"
  ...
  {"connection_recycle", OPT_CONNECTION_RECYCLE,
   ...
   &connection_recycle,
   &connection_recycle, 0, GET_BOOL, NO_ARG, 0, 0, 1, 0, 1, 0},
  ...
  {"slow_log_if_rows_examined_exceed", OPT_SLOW_LOG_IF_ROWS_EXAMINED_EXCEED,
   "log queries that examine more than slow_log_if_rows_examined rows to file.",
   &global_system_variables.slow_log_if_rows_examined_exceed,
   &max_system_variables.slow_log_if_rows_examined_exceed, 0, GET_ULONG,
   REQUIRED_ARG, 0, 0, ULONG_MAX, 0, 1L, 0},
  ...
  {"query_cache_skip_leading_comment", OPT_QUERY_CACHE_SKIP_LEADING_COMMENT,
   ...
   &query_cache_skip_leading_comment,
   &query_cache_skip_leading_comment,
  ...
  {"relay_log_purge", OPT_RELAY_LOG_PURGE,
   ...
   1, 0, 1, 0, 1, 0},
  {"relay_fsync_freq", OPT_RELAY_FSYNC_FREQ,
   "0 = do not fsync relay logs until rotation. "
   "N = fsync relay logs every N bytes.",
   &relay_io_fsync_freq,
   &relay_io_fsync_freq, 0, GET_ULL, REQUIRED_ARG,
   1ULL << 27, 0, ULONG_MAX, 0, IO_SIZE, 0},
  ...
  {"net_compression_level", OPT_NET_COMPRESSION_LEVEL,
   ...
   &net_compression_level, &net_compression_level,
  ...
  {"rpl_event_buffer_size", OPT_RPL_EVENT_BUFFER_SIZE,
   ...
   0, 1, 0},
  {"rpl_read_size", OPT_RPL_READ_SIZE,
   "The size for reads done from the binlog and relay log.",
   &rpl_read_size, &rpl_read_size,
   0, GET_ULONG, REQUIRED_ARG,
   IO_SIZE * 2,    /* the default size */
   IO_SIZE * 2,    /* the minimum size */
...
SHOW_VAR status_vars[]= {
  ...
  {"Collect_stats_seconds",    (char*) offsetof(STATUS_VAR, collect_stats_seconds), SHOW_DOUBLE_STATUS},
  {"Command_seconds",          (char*) offsetof(STATUS_VAR, command_seconds), SHOW_DOUBLE_STATUS},
  ...
  {"Exec_seconds",             (char*) offsetof(STATUS_VAR, exec_seconds), SHOW_DOUBLE_STATUS},
  ...
  {"Open_tables_seconds",      (char*) offsetof(STATUS_VAR, open_table_seconds), SHOW_DOUBLE_STATUS},
  {"Opened_files",             (char*) &my_file_total_opened, SHOW_LONG_NOFLUSH},
  {"Opened_tables",            (char*) offsetof(STATUS_VAR, opened_tables), SHOW_LONG_STATUS},
  {"Opened_table_definitions", (char*) offsetof(STATUS_VAR, opened_shares), SHOW_LONG_STATUS},
  {"Opened_fast",              (char*) &opened_fast,            SHOW_LONGLONG},
  {"Opened_not_fast",          (char*) &opened_not_fast,        SHOW_LONGLONG},
  {"Parse_seconds",            (char*) offsetof(STATUS_VAR, parse_seconds), SHOW_DOUBLE_STATUS},
  {"Pre_exec_seconds",         (char*) offsetof(STATUS_VAR, pre_exec_seconds), SHOW_DOUBLE_STATUS},
  ...
  {"Relay_log_sql_wait_seconds", (char*) &relay_sql_wait_secs, SHOW_DOUBLE},
  ...
  {"Rpl_seconds_other",        (char*) &repl_event_time_other,                 SHOW_DOUBLE},
  {"Rpl_seconds_unknown",      (char*) &repl_event_times[UNKNOWN_EVENT],       SHOW_DOUBLE},
  {"Rpl_seconds_start_v3",     (char*) &repl_event_times[START_EVENT_V3],      SHOW_DOUBLE},
  {"Rpl_seconds_query",        (char*) &repl_event_times[QUERY_EVENT],         SHOW_DOUBLE},
  {"Rpl_seconds_stop",         (char*) &repl_event_times[STOP_EVENT],          SHOW_DOUBLE},
  {"Rpl_seconds_rotate",       (char*) &repl_event_times[ROTATE_EVENT],        SHOW_DOUBLE},
  {"Rpl_seconds_intvar",       (char*) &repl_event_times[INTVAR_EVENT],        SHOW_DOUBLE},
  {"Rpl_seconds_load",         (char*) &repl_event_times[LOAD_EVENT],          SHOW_DOUBLE},
  {"Rpl_seconds_slave",        (char*) &repl_event_times[SLAVE_EVENT],         SHOW_DOUBLE},
  {"Rpl_seconds_create_file",  (char*) &repl_event_times[CREATE_FILE_EVENT],   SHOW_DOUBLE},
  {"Rpl_seconds_append_block", (char*) &repl_event_times[APPEND_BLOCK_EVENT],  SHOW_DOUBLE},
  {"Rpl_seconds_exec_load",    (char*) &repl_event_times[EXEC_LOAD_EVENT],     SHOW_DOUBLE},
  {"Rpl_seconds_delete_file",  (char*) &repl_event_times[DELETE_FILE_EVENT],   SHOW_DOUBLE},
  {"Rpl_seconds_new_load",     (char*) &repl_event_times[NEW_LOAD_EVENT],      SHOW_DOUBLE},
  {"Rpl_seconds_rand",         (char*) &repl_event_times[RAND_EVENT],          SHOW_DOUBLE},
  {"Rpl_seconds_user_var",     (char*) &repl_event_times[USER_VAR_EVENT],      SHOW_DOUBLE},
  {"Rpl_seconds_format_description", (char*) &repl_event_times[FORMAT_DESCRIPTION_EVENT], SHOW_DOUBLE},
  {"Rpl_seconds_xid",          (char*) &repl_event_times[XID_EVENT],           SHOW_DOUBLE},
  {"Rpl_seconds_begin_load_query",   (char*) &repl_event_times[BEGIN_LOAD_QUERY_EVENT],   SHOW_DOUBLE},
  {"Rpl_seconds_execute_load_query", (char*) &repl_event_times[EXECUTE_LOAD_QUERY_EVENT], SHOW_DOUBLE},
  {"Rpl_seconds_table_map",    (char*) &repl_event_times[TABLE_MAP_EVENT],     SHOW_DOUBLE},
  {"Rpl_seconds_pre_ga_write_rows",  (char*) &repl_event_times[PRE_GA_WRITE_ROWS_EVENT],  SHOW_DOUBLE},
  {"Rpl_seconds_pre_ga_update_rows", (char*) &repl_event_times[PRE_GA_UPDATE_ROWS_EVENT], SHOW_DOUBLE},
  {"Rpl_seconds_pre_ga_delete_rows", (char*) &repl_event_times[PRE_GA_DELETE_ROWS_EVENT], SHOW_DOUBLE},
  {"Rpl_seconds_write_rows",   (char*) &repl_event_times[WRITE_ROWS_EVENT],    SHOW_DOUBLE},
  {"Rpl_seconds_update_rows",  (char*) &repl_event_times[UPDATE_ROWS_EVENT],   SHOW_DOUBLE},
  {"Rpl_seconds_delete_rows",  (char*) &repl_event_times[DELETE_ROWS_EVENT],   SHOW_DOUBLE},
  {"Rpl_seconds_incident",     (char*) &repl_event_times[INCIDENT_EVENT],      SHOW_DOUBLE},
